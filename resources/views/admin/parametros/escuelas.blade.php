                        ...
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#modalCrearEscuela"><i class="fas fa-plus"></i> Nuevo Departamento</button>
                            </div>
                        </div>
                        <div class="card-body">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="formModal">Nuevo Departamento</h5>
    ...
    @foreach ($escuelas as $escu)
        <div class="modal fade" id="modalEditarEscuela-{{ $escu->escu_codigo }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalEditarEscuela">Editar Departamento</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form action="{{ route('admin.eliminar.escuelas') }}" method="POST">
                    ...
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalEliminar">Eliminar Departamento</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body text-center">
                        ...
                        <h6 class="mt-2">El departamento dejará de existir dentro del sistema. <br> ¿Desea continuar de todos
                            modos?</h6>
