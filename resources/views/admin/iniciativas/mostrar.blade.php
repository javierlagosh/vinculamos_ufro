                            ...
                            <div class="card-header-action">
                                <div class="dropdown d-inline">
                                    <button class="btn btn-info dropdown-toggle" id="dropdownMenuButton2"
                                        data-toggle="dropdown" title="Iniciativas">
                                        Iniciativa </button>
                                    ...
                                    <div class="dropdown-menu dropright">
                                        ...
                                        <a href="{{ route('admin.evidencias.listar', $iniciativa->inic_codigo) }}"
                                            ...
                                            data-placement="top" title="Adjuntar evidencia"><i
                                                class="fas fa-paperclip"></i>Adjuntar evidencias</a>

                                        <a href="javascript:void(0)" class="dropdown-item has-icon icon-left"
                                            data-toggle="tooltip"
                                            onclick="eliminarIniciativa({{ $iniciativa->inic_codigo }})"
                                            data-placement="top" title="Eliminar iniciativa"><i
