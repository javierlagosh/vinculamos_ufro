...
<body>
    <div style="text-align: center;">
        <img src="https://ufro.vinculamos.org/img/logo_ufro.png" alt="logo ufro" style="width:293px;heigh:81px;">
      </div>
    ...
    <div class="contenedor">
        <div class="valor">
            ...
            <p style="font-size: 10"><strong>Descripción: </strong><span>{{$iniciativa->inic_descripcion}}</span></p>
        </div>
        <div class="valor"></div>
    ...
    <!--ODS-->
    <h1 style="text-align: center;">ODS Asociados</h1>
    ...
    <footer>
        <p>PDF generado en: https://ufro.vinculamos.org/ | Universidad de la Frontera  </p>
    </footer>
</body>
